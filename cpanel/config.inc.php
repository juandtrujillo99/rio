...
define('NOMBRE_BD', 'epiz_24337561_rio');//Nombre de la Base de datos
...
//Pestañas principales (basicas o  comunes) de la web
	...
	*/
	define("SERVIDOR", "http://joyeriario.cf");//carpeta raiz (la que contiene todos los archivos para el funcionamiento de la página)
